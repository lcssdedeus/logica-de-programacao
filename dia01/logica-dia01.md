...
Paradigma que utiliza conceitos da lógica formal para desenvolver algoritmos computacionais. É o esqueleto da programação.
...
Tradução completa do código antes da execução.
